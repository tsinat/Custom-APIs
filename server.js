'use strict'
 ...
 var server = http.createServer(function(req, res){
     ...
     switch(resource){
         case 'math': require('./math')(req, res,params); break;
         case 'sentence': require('./sentence')(req, res, params);break;
         case 'age':require('./age')(req, res, params); break;
         case 'gravatar.com': require('./gravatar')(req,res, params); break;
